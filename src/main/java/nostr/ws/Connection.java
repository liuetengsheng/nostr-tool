...
public class Connection {
    ...
    public Connection(@NonNull Relay relay,IClientMessageService service) throws Exception {
        this.relay = relay;
    ...
    private void connect() throws Exception {
        ClientListenerEndPoint clientEndPoint = new ClientListenerEndPoint(service);
